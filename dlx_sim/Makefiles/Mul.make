...
DEPENDENCE_L=\
	...
	$(PATH_CORE)/$(TARGET_LEVEL).0-AddSub.vhd\
	$(PATH_CORE)/$(TARGET_LEVEL).0-BoothEncoder.vhd\
	$(PATH_CORE)/$(TARGET_LEVEL).0-BoothGenerator.vhd\
	$(PATH_CORE)/$(TARGET_LEVEL).a-BoothMul.vhd\
